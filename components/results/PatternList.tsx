...
export default function PatternList({ patterns }: Props) {
  ...
  return (
    <div className="glass rounded-2xl p-6">
      <h3 className="text-slate-100 font-semibold mb-1">Problem Patterns Detected</h3>
      <p className="text-slate-500 text-xs mb-6">{patterns.length} recurring patterns identified in log data</p>
          ...
          return (
            <div key={i} className="rounded-xl bg-white/3 border border-white/8 p-4 space-y-3">
              <div className="flex items-start justify-between gap-2">
                <p className="text-slate-200 text-sm font-semibold leading-tight">{p.name}</p>
